...
const schema = z.object({
    description: z.string().min(3, { message: 'Description should have 3 characters ' }).max(50),
    amount: z.number({ invalid_type_error: 'Amount field is required' }).min(0.01, { message: 'Amount should be  ' }).max(1_000_000),
